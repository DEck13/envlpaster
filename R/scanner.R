...
#' @param coef The MLE of the parameter of interest.
#' @param u The dimension of the envelope space assumed.
#' @returns
#'   \item{indices}{The indices of the \code{u} most relevant eigenvectors of \code{M} to the construction of \code{coef}.}
#'   \item{table}{An output table. The first column is the projection of \code{coef} into the space spanned by the eigenvectors given by the \code{indices}.}
#'   \item{G}{The \code{u} most relevant eigenvectors of \code{M} to the construction of \code{coef}.}
#'   \item{prop}{the sum of the remaining eigenvalues of \code{M} divided by the sum of all of the eigenvalues of \code{M}.}
